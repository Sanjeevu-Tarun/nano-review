...
export const setupRoutes = (fastify) => {
    ...
    // ── /api/search ───────────────────────────────────────────────────────────
    // Search runs on persistent parked page (no browser launch per request).
    // Scrape runs in parallel as soon as we have the device URL.
    ...
    // ── /api/compare ──────────────────────────────────────────────────────────
    // Both searches run in parallel, then scrape.
